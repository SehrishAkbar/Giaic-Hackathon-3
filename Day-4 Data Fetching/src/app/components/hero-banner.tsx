...
export default function HeroBanner() {
  ...
  return (
    ...
    <div ref={bannerRef} className="relative min-h-[700px] md:min-h-[600px] lg:min-h-[700px] flex flex-col md:block overflow-hidden">
      ...
      <div className={`relative flex-grow md:absolute md:inset-0 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-110'}`}> {/* Ensure parent has width & height */}
  <Image 
    src="/banner.png"
